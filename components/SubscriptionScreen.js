...
// DISABLING ESLINT SINCE FILE IS UNUSED
/* eslint-disable */
...
class Subscription extends React.Component {
    ...
    sumBoxes = (subscriptions, type) => subscriptions.reduce((sum, subscription) => sum + subscription[type], 0)
